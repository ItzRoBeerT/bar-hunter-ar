				...
				<div className="p-6 space-y-4" style={{backgroundColor:'#B5290E'}}>
					...
					<div className="flex gap-3 pt-2">
						...
						{bar.gameType === 'spin-bottle' && (
							<Button onClick={() => navigate(`/games/ruleta`)} className="flex-1" variant="default">
								Jugar
							</Button>
						)}
						{bar.gameType === 'flip-card' && (
							<Button onClick={() => navigate(`/games/card-game`)} className="flex-1" variant="default">
								Jugar
							</Button>
						)}
            {
