...
export const Ruleta: React.FC = () => {
		...
		() => [
			{
				...
				icon: (
					<svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
						<path
							d="M7 3h10l-1 7a5 5 0 0 1-8 0L7 3z"
							stroke="white"
							strokeWidth="1.2"
							strokeLinecap="round"
			...
			},
			{
				...
				icon: (
					<svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						/>
						<path
							d="M6 8h12l-1 9a4 4 0 0 1-8 0L6 8z"
							stroke="white"
							strokeWidth="1.2"
							strokeLinecap="round"
							strokeLinejoin="round"
			...
			},
			{
				...
				icon: (
					<svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						/>
						<path
							d="M17 9l3 3-1 5-4 3-4-3-1-5 3-3"
							stroke="#B91C1C"
							strokeWidth="1.2"
							strokeLinecap="round"
							strokeLinejoin="round"
			...
			{
				id: 'sing',
				label: 'Canta una canción',
				color: '#60A5FA',
				icon: (
					<svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
						<path
							d="M9 9v6a3 3 0 1 0 6 0V6h4"
							stroke="white"
							strokeWidth="1.2"
							strokeLinecap="round"
							strokeLinejoin="round"
	...
	return (
		<div>
			...
			<div
				className="min-h-screen p-4 pt-10"
						...
						<div className="flex flex-col lg:flex-row items-center justify-center gap-12">
							...
							<div className="relative">
								...
								<div
									...
									style={{
										boxShadow:
											'0 0 0 8px rgba(255,215,0,0.5), 0 0 0 16px rgba(255,255,255,0.3), 0 15px 40px rgba(0, 0, 0, 0.4)',
								...
								>
											...
											{slices.map((s, i) => {
												...
												return (
													<g key={s.id}>
														...
														/>
														<g
															transform={`translate(${iconPos.x - 10}, ${
																iconPos.y - 10
															})`}
														>
															<rect
									...
									<div className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 z-20 flex flex-col items-center">
										<img
											...
											alt="botella"
											onClick={startSpin}
											className={`w-64 h-64 md:w-72 md:h-72 object-contain cursor-pointer transition-opacity duration-300 ${
												spinning ? '' : 'hover:scale-110'
											}`}
											style={{
								...
								{result ? (
									...
									>
										...
										<div className="absolute inset-0 opacity-20">
											...
											<div
												className="absolute top-0 right-0 w-4 h-4 bg-blue-500 rounded-full animate-ping"
												style={{ animationDelay: '0.2s' }}
											/>
											<div
												className="absolute bottom-0 left-0 w-4 h-4 bg-green-500 rounded-full animate-ping"
												style={{ animationDelay: '0.4s' }}
											/>
											<div
												className="absolute bottom-0 right-0 w-4 h-4 bg-purple-500 rounded-full animate-ping"
									...
									<div
										...
										style={{
											background:
												'linear-gradient(135deg, rgb(180, 180, 180) 0%, rgb(140, 140, 140) 100%)',
