            ...
            >
              <div className="flex items-center space-x-4">
                ...
                <button
                  type="button"
                  onClick={() => {
                    // TODO: Implementar funcionalidad de voz
                  }}
                  className="p-3 bg-gray-100 hover:bg-gray-200 text-gray-600 hover:text-gray-800 rounded-full transition-all duration-200 shadow-md hover:shadow-lg transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
                  disabled={isTyping}
