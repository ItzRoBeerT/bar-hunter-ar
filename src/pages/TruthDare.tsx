      ...
      if (switchCount >= maxSwitches) {
        ...
        setTimeout(() => {
          ...
          if (resultAudioRef.current) {
            ...
            resultAudioRef.current.play().catch(error => console.error('Error playing result sound:', error));
          }
        }, 250);
      }
    }, 250);
              ...
              <div className="flex flex-col md:flex-row gap-8 w-full max-w-4xl">
                ...
                <div 
                  className={`flex-1 p-8 rounded-3xl transition-all duration-300 transform ${
                    isAnimating ? 'pointer-events-none' : (!isFirstGame && !currentChallenge ? 'hover:scale-105 cursor-pointer' : '')
                  } ${highlightTruth ? 'animate-pulse scale-110' : ''}`}
                  style={{
                    background: highlightTruth || selectedType === 'truth' 
                      ? 'linear-gradient(135deg, #60A5FA 0%, #3B82F6 100%)' 
                      : 'linear-gradient(135deg, #93C5FD 0%, #60A5FA 100%)',
                    boxShadow: highlightTruth 
                      ? '0 0 50px rgba(59, 130, 246, 0.8), 0 20px 40px rgba(59, 130, 246, 0.4)' 
                      : '0 10px 30px rgba(59, 130, 246, 0.3)',
                    border: highlightTruth ? '4px solid #ffffff' : '2px solid rgba(255,255,255,0.5)',
                  }}
                ...
                >
                  <div className="text-center">
                    ...
                    <p style={{ color: 'rgba(255,255,255,0.9)', fontSize: '1.2rem', fontWeight: '600' }}>
                ...
                <div 
                  ...
                  style={{
                    background: highlightDare || selectedType === 'dare' 
              ...
              {currentChallenge && (
                ...
                >
                  ...
                  <div className="absolute inset-0 opacity-20">
                    ...
                    <div className="absolute top-1/2 left-2 w-4 h-4 bg-blue-400 rounded-full animate-ping" style={{ animationDelay: '0.8s' }} />
                    <div className="absolute top-1/2 right-2 w-4 h-4 bg-red-400 rounded-full animate-ping" style={{ animationDelay: '1s' }} />
                  </div>
